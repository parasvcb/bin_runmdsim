...
import sys
if len(sys.argv)!=5:
    print ("please enter correct cmd 1. directoryHavingFilestructure 2. equilibration till 10 ns (10 conf files should be ready) or production (1 for former 2 for latter) 3. production run in ns (100 for latte 0 for former) 4. DoneProductionTime(if no dcd immediately available then enter time in ns else False)")
    sys.exit()
